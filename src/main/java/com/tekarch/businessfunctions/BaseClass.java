package com.tekarch.businessfunctions;
...
public class BaseClass {
	...
	@BeforeMethod
	@Parameters("browser")
	public static void setUp(Method method, @Optional("chrome") String browser) {
		System.out.println("Base Class before method started for method : " + method.getName());
